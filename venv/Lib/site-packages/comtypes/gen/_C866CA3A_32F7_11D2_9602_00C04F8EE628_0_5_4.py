...
__all__ = [
    'SPVPRI_ALERT', 'SVP_3', 'SPSTREAMFORMATTYPE',
    'DISPID_SRSAudioStatus', 'DISPID_SRGReset',
    'DISPID_SPEEngineConfidence', 'ISpVoice', 'SRSEDone',
    'SpeechAudioVolume', 'ISpeechObjectTokens',
    'DISPID_SpeechRecognizerStatus', 'SAFT12kHz16BitMono',
    'SDA_No_Trailing_Space', 'SpeechTokenValueCLSID',
    ...
    'SP_VISEME_13', 'SPEI_REQUEST_UI', 'SAFT11kHz16BitStereo',
    'SGDSInactive', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVSpeakCompleteEvent', 'SVP_12', 'ISpRecognizer',
    'DISPID_SpeechLexiconWords', 'SP_VISEME_2', 'STCInprocHandler',
    'IEnumString', 'SVSFUnusedFlags', 'SPEI_HYPOTHESIS',
    'eLEXTYPE_PRIVATE12', 'SpVoice', 'DISPID_SVSCurrentStreamNumber',
    'SPSNoun', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVEAudioLevel',
    'SPBOOKMARKOPTIONS', 'DISPID_SPIRetainedSizeBytes',
    'SAFTADPCM_22kHzMono', 'DISPID_SRCPause', 'DISPID_SLPs_NewEnum',
    'SP_VISEME_15', 'SGRSTTRule', 'DISPID_SFSOpen', 'SVP_17',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechVoiceSpeakFlags',
    'SAFT32kHz16BitMono', 'DISPID_SVEStreamStart', 'SVP_2',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVAudioOutputStream', 'SpeechAudioFormatType',
    'ISpNotifyTranslator', 'SPRECOCONTEXTSTATUS', 'SVSFNLPSpeakPunc',
    'SRTSMLTimeout', '_ISpeechVoiceEvents', 'DISPID_SOTCDefault',
    'SPEI_SR_RETAINEDAUDIO', 'ISpEventSource', 'SRSActive',
    'SRTExtendableParse', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechPhraseElements', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRsFindRule',
    'ISpeechLexicon', 'SVPAlert', 'SDKLDefaultLocation',
    'DISPID_SOTsItem', 'SVSFIsNotXML', 'DISPID_SBSFormat',
    'DISPID_SDKSetLongValue', 'DISPID_SPRs_NewEnum', 'SVP_7',
    'DISPID_SLWsCount', 'SECFIgnoreCase', 'SpSharedRecognizer',
    'DISPID_SVGetProfiles', 'DISPID_SMSAMMHandle', 'SPWAVEFORMATTYPE',
    'DISPID_SDKEnumKeys', 'SPEI_PHONEME', 'SPINTERFERENCE', 'SINone',
    'SpObjectToken', 'SFTInput', 'DISPID_SRCRetainedAudioFormat',
    'SpMMAudioOut', 'ISpeechRecoResultDispatch',
    'SAFTCCITT_ALaw_8kHzMono', 'SPBO_PAUSE', 'SGSExclusive',
    'SPSModifier', 'DISPID_SGRSTransitions', 'SpeechGrammarWordType',
    'SECFIgnoreKanaType', 'eLEXTYPE_APP', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCVoice', 'SpeechPropertyAdaptationOn',
    'SpeechPropertyResponseSpeed',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SLRemovePronunciation', 'SpeechAudioFormatGUIDWave',
    'DISPID_SGRAttributes', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVSInputSentencePosition', 'SpeechVoiceEvents',
    'SPVPRI_NORMAL', 'SpeechTokenIdUserLexicon',
    'ISpeechRecoResultTimes', 'SP_VISEME_7', 'DISPID_SPARecoResult',
    'DISPID_SLPType', 'SPSFunction', 'DISPID_SRSetPropertyString',
    'SRERequestUI', 'SPEI_MAX_SR', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechRecognizerState', 'STCAll', 'SPSHORTCUTPAIR',
    'DISPID_SpeechAudio', 'ISpPhoneticAlphabetConverter',
    ...
    'DISPID_SVEWord', 'SpeechCategoryPhoneConverters',
    'SpeechDataKeyLocation', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPEsCount', 'SRAORetainAudio', 'SpeechGrammarState',
    'DISPID_SGRs_NewEnum', 'SAFT8kHz16BitMono',
    'ISpeechGrammarRuleState', 'SREStreamStart', 'ISpPhoneConverter',
    'DISPID_SRRGetXMLResult', 'ISpeechBaseStream',
    'DISPID_SRCRecognizer', 'SpStream', 'SPGS_EXCLUSIVE',
    'SREAllEvents', 'ISpPhrase', 'SGLexical', 'DISPID_SGRSRule',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVVolume', 'SpeechEmulationCompareFlags', 'SPRST_ACTIVE',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechResourceLoader', 'SAFTADPCM_11kHzMono',
    'SpInProcRecoContext', 'DISPID_SVSVisemeId',
    'SPINTERFERENCE_TOOSLOW', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechGrammarRuleStateTransition', 'SPEI_RECO_STATE_CHANGE',
    'ISpRecoContext2', 'SPCT_SLEEP', 'SASStop', 'SpeechPartOfSpeech',
    'SDTProperty', 'SPPS_Noncontent', 'ISpeechRecognizerStatus',
    'DISPID_SOTMatchesAttributes', 'DISPID_SLWs_NewEnum',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SGRsDynamic',
    'DISPID_SMSSetData', 'DISPID_SDKGetStringValue',
    'SDA_One_Trailing_Space', 'DISPID_SOTId',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRRTTickCount',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechGrammarRules',
    'SVEWordBoundary', 'DISPID_SLWWord', 'SPEI_PHRASE_START',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechPhraseReplacements',
    'SpeechStreamSeekPositionType', 'DISPID_SAVolume',
    'DISPID_SRCEPhraseStart', 'STSF_LocalAppData', 'SGSEnabled',
    'DISPID_SVEViseme', 'DISPID_SOTRemove', 'DISPID_SABIEventBias',
    'ISpNotifySink', 'eLEXTYPE_LETTERTOSOUND', 'ISpeechDataKey',
    'ISpeechLexiconWord', 'SPAUDIOOPTIONS', 'SPCS_ENABLED',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRAudioInput',
    'DISPID_SRGCmdLoadFromResource', 'SP_VISEME_5',
    'DISPID_SVSLastResult', 'SPCT_SUB_COMMAND',
    'SSSPTRelativeToStart', 'SpeechLexiconType',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechVoice',
    'DISPID_SPPChildren', 'SPSEMANTICERRORINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPGS_ENABLED',
    'SAFT12kHz8BitMono', 'SPEVENT', 'ISpeechPhraseProperties',
    'DISPID_SPRsItem', 'SPSVerb', 'SPXRO_SML', 'SSTTTextBuffer',
    'DISPID_SVGetAudioInputs', 'SDKLCurrentConfig', 'LONG_PTR',
    'SPAO_NONE', 'DISPID_SABIMinNotification',
    'DISPID_SGRInitialState', 'SpPhoneticAlphabetConverter',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SABufferInfo', 'ISpeechAudio',
    'SAFT8kHz8BitStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpPhraseInfoBuilder', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSInputWordLength', 'SDTAudio',
    'ISpeechPhraseReplacement', 'eLEXTYPE_PRIVATE7', 'SWTDeleted',
    'SVP_10', 'DISPID_SpeechVoiceEvent', 'DISPID_SDKGetlongValue',
    'SPVOICESTATUS', 'SPSUnknown', 'DISPID_SASCurrentDevicePosition',
    'tagSPPROPERTYINFO', 'DISPID_SpeechPhraseElements', 'SRSInactive',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLPSymbolic',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SLPLangId',
    'eLEXTYPE_PRIVATE4', 'SAFT48kHz8BitStereo', 'SGRSTTDictation',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRRAlternates',
    'DISPID_SVSInputSentenceLength', 'SSTTDictation', 'SPAS_PAUSE',
    'SAFT22kHz16BitStereo', 'SPEI_WORD_BOUNDARY',
    'DISPID_SWFESamplesPerSec', 'SVP_11', 'eWORDTYPE_DELETED',
    'DISPIDSPTSI', 'SpeechBookmarkOptions', 'ISpeechRecoResult2',
    'SpeechGrammarTagWildcard', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SLPPhoneIds', 'DISPID_SVVoice', 'DISPID_SRRTimes',
    'SGDSActiveUserDelimited', 'DISPID_SPRuleId', 'DISPID_SPRuleName',
    'SVSFVoiceMask', 'SVP_1', 'DISPID_SLWType', 'DISPID_SGRSTsCount',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRSTPropertyName',
    'DISPID_SpeechPhraseAlternate', 'SGRSTTEpsilon',
    'SPRECOGNIZERSTATUS', 'SAFT32kHz8BitMono', 'SPPARTOFSPEECH',
    'DISPID_SVRate', 'SPCT_SUB_DICTATION', 'DISPID_SGRSTType',
    'SGLexicalNoSpecialChars', 'SpCustomStream', 'SPWT_DISPLAY',
    'SFTSREngine', 'DISPID_SGRSTs_NewEnum', 'SP_VISEME_11',
    'ISpeechPhraseInfo', 'SDTLexicalForm', 'SVEViseme',
    'SpeechRecoProfileProperties', 'DISPID_SPRulesCount',
    'SpSharedRecoContext', 'SPEI_END_INPUT_STREAM',
    'ISpeechLexiconPronunciations', 'DISPID_SPPFirstElement',
    'eLEXTYPE_PRIVATE17', 'SSFMOpenForRead',
    'DISPID_SpeechLexiconWord', 'DISPID_SWFEExtraData',
    'SREFalseRecognition', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SGRSTText', 'SRADynamic', 'SPGRAMMARWORDTYPE',
    'DISPID_SVGetVoices', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SAFSetWaveFormatEx', 'SPWF_INPUT',
    'DISPID_SRCERecognition', 'SpeechGrammarTagDictation',
    'IInternetSecurityMgrSite', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPRules_NewEnum', 'SPLOADOPTIONS',
    'DISPID_SPEAudioSizeTime', 'SPEI_SR_BOOKMARK',
    'DISPID_SPEPronunciation', 'SVF_None',
    'SAFTCCITT_uLaw_8kHzStereo', 'SREInterference', 'SP_VISEME_16',
    'SPWORD', '_SPAUDIOSTATE', 'SAFT11kHz16BitMono', 'SPEI_RESERVED1',
    'ISpeechAudioStatus', 'SPLEXICONTYPE', 'DISPID_SPPId',
    'DISPID_SpeechRecognizer', 'DISPID_SPCPhoneToId',
    'DISPID_SMSALineId', 'STSF_FlagCreate', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechPhraseBuilder', 'SBOPause',
    'ISpeechPhraseInfoBuilder', 'SpMMAudioIn', 'SPFM_NUM_MODES',
    'SpObjectTokenCategory', 'SAFT48kHz16BitMono',
    'DISPID_SOTCategory', 'DISPID_SpeechPhraseRules', 'SP_VISEME_18',
    'DISPID_SOTCSetId', 'STCRemoteServer', 'SDTRule',
    'eLEXTYPE_RESERVED10', 'SAFT22kHz8BitStereo', 'SINoise', 'SVP_14',
    'SpUnCompressedLexicon', 'DISPID_SVEPhoneme', 'SAFT24kHz8BitMono',
    'SPPHRASE', 'SAFTCCITT_uLaw_11kHzMono',
    ...
    'SECFDefault', 'SVF_Emphasis', 'DISPID_SPRuleFirstElement',
    'SAFT22kHz8BitMono', 'SPEI_RESERVED6', 'SRATopLevel',
    'DISPID_SRGRecoContext', 'SSTTWildcard', 'SPPS_SuppressWord',
    'SPEI_RECOGNITION', 'SSFMOpenReadWrite',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCEBookmark', 'ISpResourceManager', 'SpInprocRecognizer',
    'SpeechSpecialTransitionType', 'DISPID_SpeechLexicon',
    'SPSMF_SRGS_SAPIPROPERTIES', 'eLEXTYPE_PRIVATE10',
    'SECNormalConfidence', 'DISPID_SRGCmdSetRuleState',
    'SpeechRecognitionType', 'DISPID_SAEventHandle',
    'Speech_Default_Weight', 'SPPS_Function',
    'DISPID_SRCEStartStream', 'SpeechCategoryRecognizers',
    'DISPID_SRGDictationSetState', 'DISPID_SRGetFormat',
    'SAFTNoAssignedFormat', 'SAFTCCITT_ALaw_11kHzStereo',
    'SRTEmulated', 'SPLO_DYNAMIC', 'DISPID_SPPValue',
    'SpeechAudioState', 'DISPID_SRRecognizer',
    'DISPID_SPAStartElementInResult', 'SGRSTTWildcard', 'SPSLMA',
    'DISPID_SVWaitUntilDone', 'SpeechVisemeType',
    'DISPID_SVEStreamEnd', 'SLTUser', 'SpCompressedLexicon',
    'DISPID_SPACommit', 'SpeechVisemeFeature', 'DISPID_SASetState',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechGrammarRule', 'SAFTText',
    'DISPID_SRGRules', 'SPWT_LEXICAL', 'DISPID_SRSSupportedLanguages',
    'DISPID_SGRName', 'ISpStream', 'DISPID_SGRsCommitAndSave',
    'SPWORDTYPE', 'ISpRecoResult', 'DISPID_SPAs_NewEnum', 'SPPS_Noun',
    'DISPID_SBSWrite', 'SPSHT_Unknown', 'SAFT24kHz16BitMono',
    'SpPhoneConverter', 'SpeechDisplayAttributes', 'SLODynamic',
    'DISPID_SpeechFileStream', 'DISPID_SGRsAdd', 'SPEVENTENUM',
    'ISpeechPhraseElement', 'SpLexicon',
    'DISPID_SRGSetWordSequenceData', 'SPEI_START_INPUT_STREAM',
    'SPSEMANTICFORMAT', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTADPCM_44kHzMono',
    'SPWORDPRONUNCIATION', 'SP_VISEME_17', 'SPCT_DICTATION',
    'DISPID_SPAsCount', 'SPSHT_NotOverriden', 'SPPS_RESERVED2',
    ...
    'SPGRAMMARSTATE', 'DISPID_SRGetPropertyNumber',
    'SAFTExtendedAudioFormat', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SASState', 'eLEXTYPE_PRIVATE6', 'SVEStartInputStream',
    'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE11',
    'DISPID_SGRSAddWordTransition', 'SRAInterpreter',
    'SAFTADPCM_8kHzMono', 'SPGS_DISABLED', 'DISPID_SOTGetAttribute',
    'DISPID_SGRSTsItem', 'SPEI_RESERVED2', 'DISPID_SDKCreateKey',
    'SRAONone', 'DISPID_SPIRule', 'SPAUDIOSTATUS',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPAPhraseInfo',
    'SpeechUserTraining', 'SpeechPropertyResourceUsage',
    'DISPID_SRCESoundStart', 'SPAS_RUN', 'DISPID_SRCESoundEnd',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE19',
    'ISpeechVoice', 'SPDKL_DefaultLocation',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVSPhonemeId',
    'SPSNotOverriden', 'DISPID_SPEDisplayAttributes',
    'SVSFPersistXML', 'DISPID_SLGenerationId',
    'SAFTADPCM_11kHzStereo', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SOTs_NewEnum', 'SREPrivate', 'SITooSlow',
    'DISPID_SVSRunningState', 'DISPID_SOTGetDescription',
    'ISpeechWaveFormatEx', 'SDTPronunciation',
    'DISPID_SWFEBlockAlign', 'SpeechEngineConfidence', 'UINT_PTR',
    'ISpNotifySource', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpObjectWithToken', 'ISpGrammarBuilder', 'DISPID_SLWsItem',
    'SPPHRASEPROPERTY', 'DISPID_SRGIsPronounceable',
    'SpeechRetainedAudioOptions', 'ISpMMSysAudio',
    'SpResourceManager', 'DISPID_SVSpeak', 'DISPID_SBSSeek',
    'SRCS_Disabled', 'SREAudioLevel', 'DISPID_SASFreeBufferSpace',
    'ISpeechLexiconWords', 'SAFT24kHz8BitStereo',
    'DISPID_SPIGetDisplayAttributes', 'SAFTGSM610_22kHzMono',
    'ISpeechRecoGrammar', 'SAFT44kHz8BitMono', 'SVP_0',
    'SpNotifyTranslator', 'DISPIDSPRG', 'DISPID_SpeechPhraseProperty',
    'DISPID_SAFGuid', 'DISPID_SRCERecognizerStateChange',
    'SPPS_Interjection', 'DISPID_SVPause', 'DISPID_SPIProperties',
    'SP_VISEME_8', 'DISPID_SGRId', 'SSFMCreate', 'DISPID_SRState',
    'SPRST_INACTIVE_WITH_PURGE', 'SDKLLocalMachine',
    'ISpPhoneticAlphabetSelection', 'SP_VISEME_20',
    'DISPID_SGRSTNextState', 'SPEI_FALSE_RECOGNITION',
    'SWPKnownWordPronounceable', 'SpMMAudioEnum',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechAudioFormatGUIDText',
    'SP_VISEME_6', 'ISpeechRecoResult', 'SPDKL_CurrentConfig',
    'SP_VISEME_9', 'DISPID_SASCurrentSeekPosition',
    'SPEI_VOICE_CHANGE', 'DISPID_SRSCurrentStreamPosition',
    'SPVPRI_OVER', 'SPXMLRESULTOPTIONS', 'SREAdaptation',
    '_ISpeechRecoContextEvents', 'DISPID_SDKDeleteKey', 'SDTAll',
    'ISpeechPhraseAlternates', 'DISPID_SpeechRecoContext',
    'SPDATAKEYLOCATION', 'SP_VISEME_14', 'SPPS_LMA',
    ...
    'ISpeechXMLRecoResult', 'DISPID_SRGSetTextSelection', 'SITooFast',
    'ISpeechGrammarRule', 'SPEI_SR_PRIVATE', 'SITooLoud',
    'DISPID_SRGCommit', 'DISPID_SPIElements', 'SDTAlternates',
    'SpeechRuleAttributes', 'SAFT8kHz16BitStereo',
    'DISPID_SVESentenceBoundary', 'ISpStreamFormatConverter',
    'SPRULE', 'SPBINARYGRAMMAR', 'DISPID_SRCreateRecoContext',
    'SRCS_Enabled', 'SPPS_RESERVED1', 'SPRS_ACTIVE',
    'eLEXTYPE_PRIVATE20', 'DISPID_SDKDeleteValue', 'SPWF_SRENGINE',
    'SGSDisabled', 'DISPID_SADefaultFormat', 'DISPID_SFSClose',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SGRSTPropertyId',
    'SPEI_TTS_PRIVATE', 'DISPID_SVEventInterests', 'DISPID_SOTSetId',
    'ISpAudio', 'DISPID_SRCEventInterests', 'SVSFlagsAsync',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRCEInterference',
    'DISPID_SRRRecoContext', 'DISPID_SGRsCount',
    'DISPID_SpeechObjectTokens', 'SECFEmulateResult',
    'DISPID_SRSCurrentStreamNumber', 'SRARoot',
    'DISPID_SRRTOffsetFromStart', 'SPINTERFERENCE_NONE',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_RESERVED7', 'SRESoundEnd',
    'SVSFIsFilename', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPPConfidence', 'DISPID_SPIAudioSizeTime', 'SRAExport',
    'SPSHORTCUTPAIRLIST', 'DISPID_SGRsItem', 'DISPID_SMSADeviceId',
    'SpeechAddRemoveWord', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SWFEFormatTag', 'DISPID_SRCRetainedAudio',
    'DISPID_SABIBufferSize', 'SPEI_TTS_BOOKMARK', 'SpeechRunState',
    'DISPID_SVSkip', 'SVP_4', 'Speech_StreamPos_RealTime',
    'SREPropertyNumChange', 'DISPID_SPPParent', 'SRTStandard',
    'SPEI_SOUND_START', 'DISPID_SVEAudioLevel', 'SECLowConfidence',
    'DISPID_SpeechLexiconPronunciation', 'SPPROPERTYINFO',
    'DISPID_SRRTLength', 'DISPID_SVStatus', 'DISPID_SRRTStreamTime',
    'DISPID_SRIsShared', 'DISPID_SpeechPhraseReplacements',
    'SAFTDefault', 'DISPID_SRCCmdMaxAlternates', 'SPWORDLIST',
    'eLEXTYPE_RESERVED8', 'SVF_Stressed', 'ISpEventSink',
    'ISpeechPhraseAlternate', 'SPSHORTCUTTYPE',
    'SpeechAudioProperties', 'SPBO_NONE', 'SVSFParseMask',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SREmulateRecognition',
    'SPSHT_OTHER', 'SGRSTTWord', 'SpeechInterference',
    'SpeechWordType', 'DISPID_SGRAddResource',
    'SpeechEngineProperties', 'WAVEFORMATEX', 'SRSInactiveWithPurge',
    'DISPID_SRGState', 'SpeechTokenKeyAttributes', 'SVSFDefault',
    'SPAS_STOP', 'SpeechCategoryAppLexicons', 'SVPNormal',
    'DISPID_SpeechCustomStream', 'SPEI_RESERVED5',
    'DISPID_SRCSetAdaptationData', 'ISpeechPhraseRule',
    'SP_VISEME_19', 'SVEPhoneme', 'SVP_5', 'DISPID_SAStatus',
    'DISPID_SVDisplayUI', 'SAFT44kHz16BitStereo',
    'DISPID_SVAlertBoundary', '_RemotableHandle', 'SPCT_COMMAND',
    'DISPID_SRRPhraseInfo', 'SPAR_High', 'DISPIDSPTSI_ActiveLength',
    'SRERecognition', 'SRERecoOtherContext', 'SAFT32kHz16BitStereo',
    'DISPID_SPRuleChildren', 'SVP_6', 'ISpeechRecognizer',
    'eLEXTYPE_RESERVED6', 'DISPID_SpeechRecoResult', 'SVEBookmark',
    'SPPS_Modifier', 'DISPID_SRCEAudioLevel',
    'SAFTCCITT_uLaw_22kHzMono', 'SpShortcut', 'DISPID_SPCLangId',
    'SRESoundStart', 'SPCONTEXTSTATE', 'DISPID_SPILanguageId',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechFileStream',
    'ISpRecoGrammar2', 'DISPID_SpeechVoiceStatus', 'SVP_9',
    'SpeechDiscardType', 'SASRun', 'SPSERIALIZEDPHRASE',
    'DISPID_SRGDictationUnload', 'SPEI_VISEME', 'SP_VISEME_1',
    'DISPID_SAFType', '__MIDL_IWinTypes_0009', 'IStream', 'SVP_8',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTIsUISupported',
    'ISpeechGrammarRuleStateTransitions', 'SPFM_CREATE',
    'SPPHRASERULE', 'DISPID_SpeechXMLRecoResult',
    'DISPIDSPTSI_ActiveOffset', 'SREPropertyStringChange',
    'SpeechRegistryUserRoot', 'DISPID_SLWLangId',
    'DISPID_SPIStartTime', 'SPDKL_LocalMachine',
    'SAFT12kHz8BitStereo', 'SINoSignal', 'DISPID_SOTsCount',
    'SECFIgnoreWidth', 'DISPID_SRSNumberOfActiveRules',
    'SVESentenceBoundary', 'SAFT11kHz8BitStereo',
    'SECFNoSpecialChars', 'DISPID_SRCResume', 'SpeechRecoEvents',
    'SWTAdded', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRCCreateGrammar', 'eLEXTYPE_PRIVATE16',
    'eLEXTYPE_PRIVATE18',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SBONone',
    'DISPID_SPRText', 'ISpRecognizer2', 'SPPS_RESERVED4',
    'SpNullPhoneConverter', 'SPAR_Low', 'SAFT8kHz8BitMono',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVEVoiceChange',
    'DISPID_SRRSpeakAudio', 'Speech_StreamPos_Asap',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPIAudioSizeBytes', 'ISpeechCustomStream',
    'DISPID_SPEsItem', 'SPVPRIORITY', 'SpeechStreamFileMode',
    'SpeechCategoryAudioOut', 'DISPID_SASNonBlockingIO',
    'SpeechRuleState', 'SPPHRASEREPLACEMENT', 'SpFileStream',
    'SAFT16kHz16BitStereo', 'DISPID_SVSInputWordPosition',
    'SRAImport', 'SPAS_CLOSED', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechObjectToken', 'ISpeechTextSelectionInformation',
    'SREHypothesis', 'ISpeechRecoContext', 'SAFT16kHz8BitMono',
    'DISPID_SRRAudioFormat', 'SPBO_TIME_UNITS', 'DISPID_SPPName',
    'SPSHT_EMAIL', 'DISPID_SPRFirstElement', 'SVP_20',
    'DISPID_SPIReplacements', 'DISPID_SRCERequestUI',
    'SAFTGSM610_11kHzMono', 'ISpRecoGrammar', 'DISPID_SPPsCount',
    'DISPID_SRAudioInputStream', 'SPPS_Unknown',
    'SpeechRecoContextState', 'DISPID_SRGId', 'SpeechMicTraining',
    'SAFT32kHz8BitStereo', 'SGDSActive',
    'DISPID_SRCEFalseRecognition', 'SVSFParseAutodetect',
    'SpeechLoadOption', 'DISPID_SGRsCommit', 'DISPID_SGRSTRule',
    'SGRSTTTextBuffer', 'DISPID_SRDisplayUI', 'SAFT48kHz16BitStereo',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SVPriority',
    'DISPID_SRGetRecognizers', 'ISpeechPhraseRules',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_MIN_TTS', 'SPPS_Verb',
    'DISPID_SCSBaseStream', 'eLEXTYPE_RESERVED4',
    'ISpeechPhraseProperty', 'DISPID_SPIEngineId',
    'IEnumSpObjectTokens', 'SP_VISEME_0', 'DISPID_SRRAudio', 'SVP_15',
    'SPXRO_Alternates_SML', 'SPWORDPRONOUNCEABLE', 'eWORDTYPE_ADDED',
    'SP_VISEME_12', 'DISPID_SRCEHypothesis',
    'DISPIDSPTSI_SelectionLength', 'SASPause', 'DISPID_SGRSTWeight',
    'SP_VISEME_10', 'SPEI_PROPERTY_NUM_CHANGE', 'STSF_CommonAppData',
    'DISPID_SRCEEndStream', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRProfile', 'DISPID_SpeechPhoneConverter',
    'SPFM_CREATE_ALWAYS', 'ISpeechMemoryStream',
    'ISpObjectTokenCategory', 'SpeechCategoryVoices',
    'IInternetSecurityManager', 'SPINTERFERENCE_TOOLOUD',
    'SDTReplacement', 'SPINTERFERENCE_TOOFAST', 'ISpRecognizer3',
    'SP_VISEME_21', 'DISPID_SpeechRecoResult2', 'ISpStreamFormat',
    'DISPID_SVSLastBookmarkId', 'DISPID_SBSRead', 'SPRST_NUM_STATES',
    'DISPID_SPRsCount', 'SP_VISEME_3', 'SWPUnknownWordPronounceable',
    'SPAR_Unknown', 'SpWaveFormatEx', 'Speech_Max_Word_Length',
    'SAFTADPCM_22kHzStereo', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechAudioBufferInfo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPIAudioStreamPosition', 'SPINTERFERENCE_NOISE',
    'SPWORDPRONUNCIATIONLIST', 'ISpRecoCategory', 'SpAudioFormat',
    'DISPID_SMSGetData', 'SpMemoryStream',
    ...
    'SPCS_DISABLED', 'tagSPTEXTSELECTIONINFO', 'SPBO_AHEAD',
    'ISpObjectToken', 'SLOStatic', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPEs_NewEnum', 'DISPID_SRStatus', 'SPLO_STATIC',
    'SPRECOSTATE', 'SRSEIsSpeaking', 'DISPID_SpeechBaseStream',
    'DISPID_SRCEEnginePrivate', 'SVPOver', 'DISPID_SGRClear',
    'DISPID_SLWPronunciations', 'DISPID_SPPsItem',
    'SpeechDictationTopicSpelling', 'SVSFParseSsml',
    'SAFT24kHz16BitStereo', 'SPFM_OPEN_READWRITE', 'SPRULESTATE',
    'SVSFNLPMask', 'DISPID_SDKEnumValues',
    'DISPID_SLAddPronunciation', 'DISPID_SPERetainedStreamOffset',
    'ISpeechMMSysAudio', 'DISPID_SRCBookmark', 'DISPID_SDKOpenKey',
    'SpeechVoicePriority', 'DISPID_SPAsItem',
    'SDA_Consume_Leading_Spaces', 'SPFM_OPEN_READONLY',
    'SPCATEGORYTYPE', 'SPSMF_UPS', 'SPEI_RESERVED3',
    'DISPID_SVIsUISupported', 'SPAO_RETAIN_AUDIO', 'SPSSuppressWord',
    'ISpProperties', 'SPRST_ACTIVE_ALWAYS', 'SGDSActiveWithAutoPause',
    'SPAUDIOSTATE', 'DISPID_SpeechPhraseInfo', 'DISPID_SOTCId',
    'SpeechWordPronounceable', 'SLTApp', 'DISPID_SRRSetTextFeedback',
    'DISPID_SVSLastBookmark', 'SPAR_Medium', 'DISPID_SPIGetText',
    'SpeechTokenKeyUI', 'SpeechFormatType', 'ISpeechGrammarRules',
    'SAFT48kHz8BitMono', 'SpeechCategoryAudioIn',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRGCmdLoadFromFile',
    'SVEPrivate', 'SREPhraseStart', 'DISPID_SPRulesItem',
    'SWPUnknownWordUnpronounceable', 'SAFT16kHz8BitStereo',
    'SPEI_END_SR_STREAM', 'SVP_13', 'SSFMCreateForWrite',
    'SSSPTRelativeToEnd', 'SPEI_MIN_SR',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechTokenContext',
    'Speech_Max_Pron_Length', 'SITooQuiet',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRSetPropertyNumber', 'SAFT22kHz16BitMono',
    'DISPID_SPRuleConfidence', 'SAFT12kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpSerializeState',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVResume',
    'DISPID_SPCIdToPhone', 'SpeechCategoryRecoProfiles',
    'SVEVoiceChange', 'SVP_19', 'ISpRecoContext', 'SVSFIsXML',
    'ISpeechVoiceStatus', 'SVP_16', 'DISPID_SPELexicalForm',
    'ISequentialStream', 'SECHighConfidence', 'SPEI_INTERFERENCE',
    'SVSFParseSapi', 'ISpeechObjectTokenCategory', 'ISpShortcut',
    'DISPID_SpeechMMSysAudio', 'SpeechTokenShellFolder',
    'SSSPTRelativeToCurrentPosition', 'SPPHRASEELEMENT',
    'DISPID_SWFEChannels', 'SP_VISEME_4', 'ISpXMLRecoResult',
    'SAFT44kHz16BitMono', 'SVP_18', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_PRIVATE1', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPEI_TTS_AUDIO_LEVEL', 'SpTextSelectionInformation',
    'SPWT_PRONUNCIATION', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT44kHz8BitStereo', 'SPSInterjection',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCCreateResultFromMemory', 'SpeechAllElements',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechMemoryStream', 'DISPID_SDKSetBinaryValue',
    'SPEI_UNDEFINED', 'STCLocalServer', 'eLEXTYPE_PRIVATE15',
    'SREStreamEnd', 'DISPID_SRCState', 'SRTReSent',
    'DISPID_SPERequiredConfidence', 'DISPID_SLPsItem',
    'SPEI_SOUND_END', 'DISPID_SPEDisplayText', 'eLEXTYPE_USER',
    'DISPID_SpeechPhraseReplacement', 'tagSTATSTG', 'SPVISEMES',
    ...
    'SVP_21', 'DISPID_SpeechDataKey', 'ISpeechAudioFormat',
    'SGDisplay', 'SpeechPropertyNormalConfidenceThreshold',
    ...
    'DISPID_SABufferNotifySize', 'DISPID_SpeechAudioFormat',
    'DISPID_SRCEAdaptation', 'STSF_AppData', 'SGPronounciation',
    'DISPID_SGRAddState', 'DISPID_SPPs_NewEnum',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRSActiveAlways',
    'SpeechTokenKeyFiles', 'SPFILEMODE',
    'DISPID_SPRDisplayAttributes', 'STCInprocServer',
    'DISPID_SLGetPronunciations', 'SPPS_NotOverriden',
    'SPRS_INACTIVE', 'DISPID_SVEEnginePrivate',
    'SAFTADPCM_44kHzStereo', 'SPEI_ADAPTATION',
    'DISPID_SVSpeakStream', 'SAFTNonStandardFormat',
    'DISPID_SOTDisplayUI', 'SPEVENTSOURCEINFO', 'SPEI_MAX_TTS',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPRuleParent',
    'DISPID_SPISaveToMemory', 'DISPID_SPEActualConfidence',
    'ISpDataKey', 'SPTEXTSELECTIONINFO', 'DISPID_SOTCreateInstance',
    'SPEI_START_SR_STREAM', 'SREBookmark', 'SDKLCurrentUser',
    'SAFT11kHz8BitMono', 'SAFTGSM610_44kHzMono', 'SPAUDIOBUFFERINFO',
    'SDTDisplayText', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPPS_RESERVED3', 'SASClosed'
]

_check_version('1.2.0', 1622475962.355041)
